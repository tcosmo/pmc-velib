...
print("Nombre de requetes : INFINI")
...
while 1:
    ...
    if curr_time-last_time > FREQ_VELIB*60:
        print("{} REQUETE {}/INFINI DEBUT".format(datetime.datetime.fromtimestamp(curr_time).strftime("%Y-%m-%d %H:%M:%S"), iReq))
        last_time = time.time()
        id_meteo = 0
