...
class HelloWorld:
    def __init__(self):
        ...
        self.choix["couche_cachee"] = 1
        self.choix["fac_app"] = "8.7"
        self.choix["neurone_couche"] = ['5']
    ...
    def on_spinbutton1_value_changed(self,widget):
        self.choix["couche_cachee"] = widget.get_value()
    
    def on_neurone_couche_changed(self,widget):
        inside = widget.get_text()
        self.choix["neurone_couche"] = inside.split('-')

    def on_fac_app_changed(self,widget):
        self.choix["fac_app"] = widget.get_text()
    
    def on_Temperature_toggled(self,widget):
        self.choix["temp"] = widget.get_active()
 
    def on_Pluie_toggled(self,widget):
        self.choix["pluie"] = widget.get_active()
